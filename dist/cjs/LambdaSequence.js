...
class LambdaSequence {
  ...
  ```
     ...
     */
    start() {
        return aws_log_1.invoke(...this.getInvocationParameters());
    }
    /**
    ...
    logger) {
        ...
        if (common_types_1.isLambdaProxyRequest(event)) {
            ...
            request = common_types_1.getBodyFromPossibleLambdaProxyRequest(event);
        ...
        request =
            typeof request === "object"
                ? Object.assign(Object.assign({}, activeFn), request)
