...
function () {
  ...
  _createClass(LambdaSequence, [{
    ...
    value: function start() {
      return invoke$1.apply(void 0, _toConsumableArray(this.getInvocationParameters()));
    }
    /**
...
function (_Error) {
  ...
  function RethrowError(err) {
    ...
    _this.httpStatus = get(err, "httpStatus", HttpStatusCodes.InternalServerError);
    return _this;
  }
...
function invoke(sequence) {
  return function (fnArn, request, additionalHeaders) {
    ...
    return invoke$1(fnArn, boxedRequest);
  };
}
  ...
  return _async$3(function (event, context) {
    ...
    return _catch(function () {
      ...
      return _await$2(fn(request, handlerContext), function (_fn) {
        ...
        return _invoke$1(function () {
          if (sequence.isSequence && !sequence.isDone) {
            ...
            return _await$2(invoke$1(_fn2, requestBody), function (invokeParams) {
          ...
          return _invoke$1(function () {
            ...
            return _invoke$1(function () {
              if (options.sequenceTracker && sequence.isSequence) {
                ...
                return _await$2(invoke$1(options.sequenceTracker, buildOrchestratedRequest(status(sequence))), function () {
                  if (sequence.isDone) {
      ...
      return _catch(function () {
        ...
        var isApiGatewayRequest = isLambdaProxyRequest(event);
        return function () {
          if (found) {
            ...
            return _invokeIgnored(function () {
              if (found.handling.forwardTo) {
                ...
                return _awaitIgnored(invoke$1(found.handling.forwardTo, e));
              }
            });
          } else {
            ...
            return _switch(handling.type, [[function () {
              ...
              try {
                ...
                if (passed === true) {
                  log.debug("The error was fully handled by this function's handling function/callback; resulting in a successful condition [ ".concat(result ? HttpStatusCodes.Accepted : HttpStatusCodes.NoContent, " ]."));
              ...
              return _awaitIgnored(invoke$1(handling.arn, e));
            }], [function () {
        ...
        return function () {
          if (forwardedByConductor) {
            return _awaitIgnored(invoke$1.apply(void 0, _toConsumableArray(forwardedByConductor)));
          } else {
