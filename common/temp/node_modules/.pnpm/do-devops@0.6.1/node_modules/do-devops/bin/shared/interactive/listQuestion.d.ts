...
export declare function listQuestion(q: Omit<ListQuestion, "type">): {
    ...
    choices?: import("inquirer").AsyncDynamicQuestionProperty<readonly import("inquirer").DistinctChoice<import("inquirer").ListChoiceMap<import("inquirer").Answers>>[], import("inquirer").Answers>;
