...
export declare type IColor = "black" | "red" | "magenta" | "yellow" | "green" | "brightRed" | "brightGreen" | "brightYellow";
export declare type Color = keyof typeof COLOR;
export declare type ColorConfigurator = (color: typeof COLOR) => [fg: number, bg: number];
export declare type ColorFormatter = (text?: string, bg?: ColorConfigurator) => string;
...
export declare type FluentOneUse<TApi extends Record<string, any>, TOneUse extends string> = TOneUse extends string ? Omit<TApi, TOneUse> : TApi;
/**
