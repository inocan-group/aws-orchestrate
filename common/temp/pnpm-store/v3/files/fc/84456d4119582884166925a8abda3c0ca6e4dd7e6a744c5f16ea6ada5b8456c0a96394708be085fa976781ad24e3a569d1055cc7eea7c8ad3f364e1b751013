...
exports.createApiGatewayError = void 0;
 ...
 */
function createApiGatewayError(projectName, fnName, defaultOptions = {}) {
    // CLASS DEFINITION
    class ApiGatewayError extends Error {
        ...
        constructor(errorCode, errorMessage, options = {}) {
            ...
            this.kind = types_1.ErrorKind.ApiGatewayError;
...
exports.createApiGatewayError = createApiGatewayError;
