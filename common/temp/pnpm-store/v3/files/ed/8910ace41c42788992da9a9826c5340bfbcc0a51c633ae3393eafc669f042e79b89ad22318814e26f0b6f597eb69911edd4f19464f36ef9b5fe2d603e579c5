...
async function handler(argv, opts) {
    ...
    await async_shelljs_1.asyncExec(command, { silent: opts.quiet ? true : false });
    ...
    await async_shelljs_1.asyncExec(`ls -l ${directory}`);
    if (opts.validate) {
        ...
        try {
            ...
            await async_shelljs_1.asyncExec(validateCmd);
        }
        catch (e) {
        ...
        try {
            ...
            await async_shelljs_1.asyncExec(validateUpdate);
        }
        catch (e) {
