...
//#autoindex, exclude: subCommands
exports.subCommands = __importStar(require("./subCommands/index"));
// #region autoindexed files
// index last changed at: 10th Oct, 2020, 08:44 AM ( GMT-7 )
// export: named; exclusions: subCommands, index, private.
// files: completeSsmName.
// local file exports
__exportStar(require("./completeSsmName"), exports);
// Note:
// -----
