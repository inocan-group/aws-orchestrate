...
export function isCompressedSection<T>(data: T | ICompressedSection): data is ICompressedSection {
  return typeof data === "object" && (data as ICompressedSection).compressed === true ? true : false;
}

export function decompress<T = any>(data: T | ICompressedSection, parse: boolean = true): T {
